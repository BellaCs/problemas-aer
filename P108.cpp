...
int main() {
    ...
    while(1) {
        ...
        switch(c) {
            case 'D':
                values[0] = values[0] + v; sum += v; numT++; break;
            case 'A':
                values[1] = values[1] + v; sum += v; numT++; numC++; break;
            case 'M':
                values[2] = values[2] + v; sum += v; numT++; break;
            case 'I':
                values[3] = values[3] + v; sum += v; numT++; break;
            case 'C':
                values[4] = values[4] + v; sum += v; numT++; break;
            default:
